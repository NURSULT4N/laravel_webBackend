...
Route::post('/contact/submit', 'App\Http\Controllers\PagesController@submit')->name('contact-form');
Route::get('/contact/all', 'App\Http\Controllers\PagesController@allData')->name('contact-data');
